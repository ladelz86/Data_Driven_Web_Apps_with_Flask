...
cp /apps/Data_Driven_Web_Apps_with_Flask/server/pypi.service /etc/systemd/system/pypi.service
...
cp /apps/Data_Driven_Web_Apps_with_Flask/server/pypi.nginx /etc/nginx/sites-enabled/pypi.nginx
